...
#   projects/eLife_2025/ops/slurm/dispatch_figure_2.sh <cluster>     # e.g. example
# Tunables via env: NCHS and N_SIMS (parallel arrays, same length), CPUS, MEM,
# TIME, PARTITION, BIN. Example:
#   NCHS="10 100" N_SIMS="2048 1024" projects/.../dispatch_figure_2.sh example
...
N_ALGO=(${N_ALGO:-macro_IR macro_R macro_MR macro_NR macro_INR})
