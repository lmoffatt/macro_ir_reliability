...
#   projects/eLife_2025/ops/slurm/dispatch_figure_3.sh <cluster>     # e.g. example
...
#     projects/eLife_2025/ops/slurm/dispatch_figure_3.sh example
#   # chain after a build job:  DEPEND=<jobid> projects/eLife_2025/ops/slurm/dispatch_figure_3.sh example
...
for i in "${!NCHS[@]}"; do
    ...
    case "$algo" in
        ...
        *) echo "[dispatch] unknown algorithm '$algo' (want macro_{NR,R,INR,MR,IR,IRT})" >&2; exit 1 ;;
    esac
