...
#   projects/eLife_2025/ops/slurm/dispatch_figure_3_G.sh <cluster>     # e.g. example
...
#     projects/eLife_2025/ops/slurm/dispatch_figure_3_G.sh example
#   # chain after a build job:  DEPEND=<jobid> projects/eLife_2025/ops/slurm/dispatch_figure_3_G.sh example
...
for i in "${!NCHS[@]}"; do
    ...
    case "$nnoise" in                    # label -> current_noise (vnoise = label / 1000)
        ...
        10000) vnoise=10;;
        100000) vnoise=100;;
        1000000) vnoise=1000;;            # added 2026-07-23 for the N_ch 1e5 rung of the diagonal
        10000000) vnoise=10000;;            # added 2026-07-26 for the N_ch 1e5 rung of the diagonal
        *) echo "[dispatch] unknown noise level '$nnoise' (want 0.05, 0.1, 0.2, 0.3, 0.5, 1, 10, 100, 1000, 10000, 100000, 1000000, 10000000; vnoise = label/1000)" >&2; exit 1 ;;
    esac
