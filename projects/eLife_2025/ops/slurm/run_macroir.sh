...
#   projects/eLife_2025/ops/build_cluster.sh example     # produces build/example-<hash>/macrodr_cli
#
#   sbatch --export=ALL,CLUSTER=example,BIN=$PWD/build/example-<hash>/macrodr_cli,WORKDIR=/scratch/$USER/macro_dr/eLife_2025 \
...
# Clementina (threaded OpenBLAS); harmless on example (sequential-MKL build
